...
(5) Mount it on four washers between the NVME-base and the bottom of the case at the same height as the M2 screw holding the NVME drive down.
Alternatively drill an 8mm hole below the NVME M.2 screw in the bottom of the case (i.e. on the USB-Ethernet side).

(6) The case is wide enough that the entire vertical assembly - from the NVME-base + RPi5 + Hat/Fan - can be done outside the case and then
